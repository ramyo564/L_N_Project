...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const learnMoreLinks = {
        ...
        'backend-spring-domain-rules': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-spring-domain-rules',
        'backend-spring-state-management': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-spring-state-management',
        'backend-spring-api-write': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-spring-api-write',
        'backend-spring-worker-consume': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-spring-worker-consume',
        'backend-spring-troubleshooting': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-spring-troubleshooting',
        'backend-fastapi-analyze': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-analyze',
        'backend-fastapi-auth': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-auth',
        'backend-fastapi-packages': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-packages',
        'backend-fastapi-domain-rules': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-domain-rules',
        'backend-fastapi-state-management': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-state-management',
        'backend-fastapi-feedback': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-feedback',
        'backend-fastapi-troubleshooting': 'https://github.com/ramyo564/L_N_Project/blob/main/Backend/README.md#lm-backend-fastapi-troubleshooting',

        // Frontend
        'frontend-monorepo-architecture': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-monorepo-architecture',
        'frontend-api-bridge': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-api-bridge',
        'frontend-package-map': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-package-map',
        'frontend-rtk-single-source': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-rtk-single-source',
        'frontend-di-composition': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-di-composition',
        'frontend-troubleshooting-patterns': 'https://github.com/ramyo564/L_N_Project/blob/main/Frontend/README.md#lm-frontend-troubleshooting-patterns',

        // DevOps
        'devops-ci-change-detection': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-ci-change-detection',
        'devops-ci-integration-gate': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-ci-integration-gate',
        'devops-cd-wireguard': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-cd-wireguard',
        'devops-image-promotion': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-image-promotion',
        'devops-compose-topology': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-compose-topology',
        'devops-docker-build-map': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-docker-build-map',
        'devops-nginx-runtime-validation': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-nginx-runtime-validation',
        'devops-edge-security': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-edge-security',
        'devops-observability-pipeline': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-observability-pipeline',
        'devops-k6-load-architecture': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-k6-load-architecture',
        'devops-stress-mode-lifecycle': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-stress-mode-lifecycle',
        'devops-troubleshooting-patterns': 'https://github.com/ramyo564/L_N_Project/blob/main/Dev/README.md#lm-devops-troubleshooting-patterns'
    };
